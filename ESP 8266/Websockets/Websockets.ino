...
const char *ssid = "Netgear1"; // The name of the Wi-Fi network that will be created
const char *password = "a3aaf93071";   // The password required to connect to it, leave blank for an open network
